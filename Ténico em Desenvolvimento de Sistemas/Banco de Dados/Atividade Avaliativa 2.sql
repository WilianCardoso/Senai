...
-- Questão 10
select e.nm_empregado'Empregado', e.salario'Salario Empregado', e.data_contratacao, d.nm_departamento, l.nm_empregado Lider, l.data_contratacao Data_Contratacao_Lider, l.salario salario_lider
